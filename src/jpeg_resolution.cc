...
static int ioh_fgetc(shared_ptr<IOHandler> ioh)
{
    uchar c[1] = {0};
...
static void get_jpeg_resolution(shared_ptr<IOHandler> ioh, int *w, int *h)
{
    int a;
...
String get_jpeg_resolution(shared_ptr<IOHandler> ioh)
{
    int w, h;
    try 
    {
