...
#ifdef _MSC_VER
  #define SPDLOG_TRACE(logger, ...) logger->trace("[" __FILENAME__ "(" SPDLOG_STR_HELPER(__LINE__) ")] " __VA_ARGS__)
  #define SPDLOG_TRACE_IF(logger, flag, ...) logger.trace_if(flag, "[ " __FILENAME__ "(" SPDLOG_STR_HELPER(__LINE__) ") ] " __VA_ARGS__)
#else
  #define SPDLOG_TRACE(logger, ...) logger->trace("[" __FILENAME__ ":" SPDLOG_STR_HELPER(__LINE__) "] " __VA_ARGS__)
  #define SPDLOG_TRACE_IF(logger, flag, ...) logger.trace_if(flag, "[" __FILENAME__ ":" SPDLOG_STR_HELPER(__LINE__) "] " __VA_ARGS__)
#endif
